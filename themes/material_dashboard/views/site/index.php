...
<div class="container">
         <?php 
            $this->widget('zii.widgets.CBreadcrumbs', array(
                'links'=>$this->appBreadcrumbs,
                'activeLinkTemplate'=>'<li class="breadcrumb-item active"><a href="{url}">{label}</a></li>',
                'inactiveLinkTemplate'=>'<li class="breadcrumb-item"><a href="{url}">{label}</a></li>',
                'tagName'=>'ol',
                'separator'=>'',
                'htmlOptions'=>array(
                        'class'=>'breadcrumb'
